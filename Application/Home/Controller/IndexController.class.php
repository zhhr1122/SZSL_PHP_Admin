...
class IndexController extends Controller {
    public function index($type=""){
        //获取首页大图数据
        $topPicNews = D("PositionContent")->selectPositionContent(array('status'=>1,'position_id'=>2),3);
        //首页小图推荐
        $topSmallNews = D("PositionContent")->selectPositionContent(array('status'=>1,'position_id'=>3),4);
        //
