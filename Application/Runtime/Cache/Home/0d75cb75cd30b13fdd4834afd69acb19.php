...
<body>
	...
	<div id="newsbanner">
		<div class="banner982">
			<div class="new_bj">
				<div class="newtit"><?php echo ($result["navs"]); ?></div>
				<div id="pr-le">
	...
	<div id="main">
		<div class="loction">当前位置: <a href="/">首页</a> > <a href="?c=cat&id=<?php echo ($result["catId"]); ?>"><?php echo ($result["navs"]); ?> ></a> <?php echo ($news["title"]); ?></div>
		<div id="main_cont">
			<div class="news_xtitzi"><?php echo ($news["title"]); ?></div>
			<div style="text-align:center">日期：<?php echo (date("Y-m-d
				H:i:s",$news["update_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;点击：<?php echo ($news["count"]); ?><script src="/manager/Plus/stat.asp?ID=51"></script></div>
...
<body>
<div id="bottom">
    <div class="bottom982"> <span class="left">深圳市世隆投资 2017 &#169; 版权所有&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;粤ICP备13082991号</span> </div>
</div>
</body>
</html>
</body>
