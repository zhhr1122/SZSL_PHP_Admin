    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/admin.php?c=content">公司简介</a>
            </li>
            <li class="active">
              <i class="fa fa-edit"></i> 修改公司简介
            </li>
          </ol>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
			...
			<input type="hidden" name="introduce_id" value ="17"/>
...
<script>
  var SCOPE = {
    'save_url' : '/admin.php?c=introduce&a=add',
